  ...
  },
  {
    ...
    answer: () => (
      <>
        ...
        4 to 5 business days. Orders shipped to countries outside of the U.S.
        can take up to 18 business days or longer. Kindpost is not responsible
        for delivery delays via the U.S. Postal Service or other delivery
        methods, including but not limited to those delays related to COVID-19.
...
const Faq = ({ location }) => {
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Because all items are handwritten to order, we are unable to accept returns or exchanges. All orders are final sale and cannot be cancelled, exchanged, or returned under any circumstances. Any items returned to Kindpost without prior notification will not be accepted and may be returned to sender. If you feel that there was a mistake on our end that caused a problem with your order, please email us at&nbsp; <a href="mailto:help@kindpostco.com">help@kindpostco.com</a>`,
        },
      },
      {
        '@type': 'Question',
        name: 'Can I select my own postcard design?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Due to the nature of our vast collection of vintage postcards, each and
        every postcard is unique, just like you! We take joy in personally
        selecting a postcard for each and every customer. At this time, our
        website does not allow for customers to select their own postcard
        design.`,
      ...
      {
        '@type': 'Question',
        name: 'Why does my postcard have discolorations or imperfections?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Due to the age of the postcards and hand-lettered nature of each message
        we send, each postcard is unique and will vary. Each postcard is vintage
        and has its own unique distressing that it has acquired over its years.
        Individual features, conditions, and appearances of actual products may
        differ from the items depicted. Any distressing, inconsistencies, and
      ...
      {
        '@type': 'Question',
        name: 'Where can I find shipping information?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Orders are typically processed and shipped within 5 business days.
        Please note that Kindpost does not ship on Sundays or U.S. nationally
        observed holidays. All orders are shipped from Southern California, and
        your delivery date is dependent upon the shipping address. Orders are
        typically shipped via U.S. Postal Service. Standard Delivery estimates
      ...
      {
        '@type': 'Question',
        name: 'I changed my mind.  Am I able to cancel my kindpost order?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Your Kindpost order cannot be canceled once it is placed. If you have
        entered the wrong mailing address, please contact us at&nbsp;
        <a href="mailto:help@kindpostco.com">help@kindpostco.com</a>
        &nbsp;immediately, and our team will make that change for you, if your
        order has not yet been prepared and shipped.`,
  ...
  return (
    <Layout
      title="FAQ | kindpost"
      description="Answers to common questions about our kindposts."
      schema={schema}
